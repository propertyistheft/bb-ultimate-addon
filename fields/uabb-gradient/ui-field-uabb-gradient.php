...
var field   = data.field,
	...
	direction = {
		'left_right' : '<?php esc_attr_e( 'Left to Right', 'uabb' ); ?>',
		'right_left' : '<?php esc_attr_e( 'Right to Left', 'uabb' ); ?>',
		'top_bottom' : '<?php esc_attr_e( 'Top to Bottom', 'uabb' ); ?>',
		'bottom_top' : '<?php esc_attr_e( 'Bottom to Top', 'uabb' ); ?>',
		'custom'     : '<?php esc_attr_e( 'Custom', 'uabb' ); ?>'
	},
