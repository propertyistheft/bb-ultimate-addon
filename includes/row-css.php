		...
		if ( isset( $row->settings->bg_type ) && 'uabb_gradient' === $row->settings->bg_type ) {
			...
			<?php if ( 'linear' === $row->settings->uabb_row_gradient_type ) { ?>
					.fl-node-<?php echo esc_attr( $row->node ); ?> > .fl-row-content-wrap {
						background-color: <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?>;
						background-image: -webkit-linear-gradient( <?php echo esc_attr( $row->settings->uabb_row_linear_direction ) . 'deg'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_linear_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_secondary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_linear_gradient_secondary_loc ) . '%'; ?>);
						background-image: -moz-linear-gradient( <?php echo esc_attr( $row->settings->uabb_row_linear_direction ) . 'deg'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_linear_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_secondary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_linear_gradient_secondary_loc ) . '%'; ?>);
						background-image: -o-linear-gradient( <?php echo esc_attr( $row->settings->uabb_row_linear_direction ) . 'deg'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_linear_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_secondary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_linear_gradient_secondary_loc ) . '%'; ?>);
						background-image: -ms-linear-gradient( <?php echo esc_attr( $row->settings->uabb_row_linear_direction ) . 'deg'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_linear_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_secondary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_linear_gradient_secondary_loc ) . '%'; ?>);
			...
			<?php if ( 'radial' === $row->settings->uabb_row_gradient_type ) { ?>
				.fl-node-<?php echo esc_attr( $row->node ); ?> > .fl-row-content-wrap {
					background-color: <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?>;
					background-image: -webkit-radial-gradient(<?php echo 'at ' . esc_attr( $row->settings->uabb_row_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_secondary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_secondary_loc ) . '%'; ?>);
					background-image: -moz-radial-gradient(<?php echo 'at ' . esc_attr( $row->settings->uabb_row_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_secondary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_secondary_loc ) . '%'; ?>);
					background-image: -o-radial-gradient(<?php echo 'at ' . esc_attr( $row->settings->uabb_row_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_secondary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_secondary_loc ) . '%'; ?>);
					background-image: -ms-radial-gradient(<?php echo 'at ' . esc_attr( $row->settings->uabb_row_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_secondary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_secondary_loc ) . '%'; ?>);
					background-image: radial-gradient(<?php echo 'at ' . esc_attr( $row->settings->uabb_row_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_primary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $row->settings->uabb_row_gradient_secondary_color ) ); ?> <?php echo esc_attr( $row->settings->uabb_row_radial_gradient_secondary_loc ) . '%'; ?>);
				}
			<?php } ?>
