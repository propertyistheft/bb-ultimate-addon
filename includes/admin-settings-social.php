...
<div id="fl-uabb-social-form" class="fl-settings-form uabb-social-fl-settings-form">
	...
	<h3 class="fl-settings-form-header"><?php esc_html_e( 'Social Login', 'uabb' ); ?></h3>
	...
	<form id="uabb-social-form" action="<?php UABBBuilderAdminSettings::render_form_action( 'uabb-social' ); ?>" method="post">
		<div class="fl-settings-form-content">
			...
			<div class="uabb-form-setting">
				<h4><?php esc_html_e( 'Google', 'uabb' ); ?></h4>
					<p class="uabb-admin-help">
						...
						if ( empty( $branding_name ) && empty( $branding_short_name ) ) :
							...
							?>
							<a target="_blank" rel="noopener" href="https://www.ultimatebeaver.com/docs/create-google-client-id-for-login-form-module/?utm_source=uabb-pro-dashboard&utm_medium=social-settings-screen&utm_campaign=login-form"><?php esc_html_e( 'article', 'uabb' ); ?></a>
					...
					<p class="uabb-admin-help"><?php esc_html_e( 'Client ID', 'uabb' ); ?></p>
					...
					<label class="uabb-social-error uabb-social-google-id-err"><?php esc_html_e( 'This field is required.', 'uabb' ); ?></label><br/>
					<p class="uabb-admin-help">
					...
					<p class="uabb-admin-help"><?php esc_html_e( 'Redirect URL', 'uabb' ); ?></p>
					...
					<label class="uabb-social-error uabb-social-google-url-err"><?php esc_html_e( 'This field is required.', 'uabb' ); ?></label><br/>
			</div>
			<br/><hr/>
			<div class="uabb-form-setting">
				<h4><?php esc_html_e( 'Facebook', 'uabb' ); ?></h4>
					<p class="uabb-admin-help">
						...
						if ( empty( $branding_name ) && empty( $branding_short_name ) ) :
							esc_attr_e( 'Refer', 'uabb' );
							?>
							<a target="_blank" rel="noopener" href="https://www.ultimatebeaver.com/docs/create-facebook-app-id-for-login-form-module/?utm_source=uabb-pro-dashboard&utm_medium=social-settings-screen&utm_campaign=login-form"><?php esc_html_e( 'article', 'uabb' ); ?></a>
					...
					<p class="uabb-admin-help"><?php esc_html_e( 'App ID', 'uabb' ); ?></p>
					...
					<label class="uabb-social-error uabb-social-facebook-id-err"><?php esc_html_e( 'This field is required.', 'uabb' ); ?></label><br/>
					<p class="uabb-admin-help">
						<?php
						if ( empty( $branding_name ) && empty( $branding_short_name ) ) :
							esc_attr_e( 'Refer', 'uabb' );
							?>
							<a target="_blank" rel="noopener" href="https://www.ultimatebeaver.com/docs/create-facebook-app-id-for-login-form-module/#step-3:-how-to-get-the-app-secret-id-/?utm_source=uabb-pro-dashboard&utm_medium=social-settings-screen&utm_campaign=login-form"><?php esc_html_e( 'article', 'uabb' ); ?></a>
					...
					<p class="uabb-admin-help"><?php esc_html_e( 'App Secret', 'uabb' ); ?></p>
					...
					<label class="uabb-social-error uabb-social-facebook-secret-err"><?php esc_html_e( 'This field is required.', 'uabb' ); ?></label><br/>
					<p class="uabb-admin-help">
						<?php esc_attr_e( 'Set a link to redirect the user after a successful login.', 'uabb' ); ?>
					</p>
					<p class="uabb-admin-help">
					...
					<label class="uabb-social-error uabb-social-facebook-url-err"><?php esc_html_e( 'This field is required.', 'uabb' ); ?></label><br/>
			</div>
			<p class="submit">
