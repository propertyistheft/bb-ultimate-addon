...
<div id="fl-uabb-branding-form" class="fl-settings-form uabb-branding-fl-settings-form">
	...
	<h3 class="fl-settings-form-header"><?php esc_html_e( 'Branding', 'uabb' ); ?></h3>
	...
	<form id="uabb-branding-form" action="<?php UABBBuilderAdminSettings::render_form_action( 'uabb-branding' ); ?>" method="post">
		...
		<div class="fl-settings-form-content">
			...
			<h4 class="field-title"><?php esc_html_e( 'Plugin Name', 'uabb' ); ?></h4>
			...
			<h4 class="field-title"><?php esc_html_e( 'Plugin Short Name', 'uabb' ); ?></h4>
			...
			<div class="uabb-branding-fields">
			<h4 class="field-title"><?php esc_html_e( 'Plugin Description', 'uabb' ); ?></h4>
			...
			<?php /* Author Name */ ?>
			<div class="uabb-branding-fields">
			<h4 class="field-title"><?php esc_html_e( 'Author / Agency Name', 'uabb' ); ?></h4>
			...
			<?php /* Author URL */ ?>
			<div class="uabb-branding-fields">
			<h4 class="field-title"><?php esc_html_e( 'Author / Agency URL', 'uabb' ); ?></h4>
			...
			<?php /* Plugin Icon URL */ ?>
			<div class="uabb-branding-fields">
			<h4 class="field-title"><?php esc_html_e( 'Plugin Icon URL', 'uabb' ); ?></h4>
			...
			<div class="uabb-branding-fields">
			<h4 class="field-title"><?php esc_html_e( 'Knowledge Base URL', 'uabb' ); ?></h4>
			<p class="uabb-admin-help"><?php esc_html_e( 'Enable this option to display Knowledge Base link in Help tab.', 'uabb' ); ?></p>
			<label>
				<input type="checkbox" class="uabb-enable-knowledge-base" name="uabb-enable-knowledge-base" value="1" <?php echo esc_attr( $uabb_enable_knowledge_base ); ?> ><?php esc_html_e( 'Enable Knowledge Base', 'uabb' ); ?>
			</label>
			...
			<div class="uabb-branding-fields">
			<h4 class="field-title"><?php esc_html_e( 'Contact Support URL', 'uabb' ); ?></h4>
			<p class="uabb-admin-help"><?php esc_html_e( 'Enable this option to display support link in Help tab.', 'uabb' ); ?></p>
				<label>
					<input type="checkbox" class="uabb-enable-contact-support" name="uabb-enable-contact-support" value="1" <?php echo esc_attr( $uabb_enable_contact_support ); ?> ><?php esc_html_e( 'Enable Contact Support', 'uabb' ); ?>
				</label>
			...
			<div class="uabb-form-setting">
				<h4><?php esc_html_e( 'Enable Template Cloud', 'uabb' ); ?></h4>
				<p class="uabb-admin-help"><?php esc_html_e( 'Enable this option to activate Template Cloud functionality.', 'uabb' ); ?></p>
				<label>
					<input type="checkbox" class="uabb-enable-template-cloud" name="uabb-enable-template-cloud" value="" <?php echo esc_attr( $uabb_enable_template_cloud ); ?> ><?php esc_html_e( 'Enable Template Cloud Settings', 'uabb' ); ?>
				</label>
			</div>
			<div class="uabb-form-setting">
				<h4><?php esc_html_e( 'List Modules under Standard Modules', 'uabb' ); ?></h4>
				<p class="uabb-admin-help"><?php esc_html_e( 'Enable this to list UABB Modules under standard modules.', 'uabb' ); ?></p>
				<label>
					<input type="checkbox" class="uabb-global-module-listing" name="uabb-global-module-listing" value="" <?php echo esc_attr( $uabb_global_module_listing ); ?> ><?php esc_html_e( 'Enable UABB modules listing in default Standard category', 'uabb' ); ?>
				</label>
			</div>

			<?php /* Hide This Form */ ?>
			<div class="uabb-form-setting">
				<h4><?php esc_html_e( 'Hide White Label Settings', 'uabb' ); ?></h4>
				<p class="uabb-admin-help"><?php esc_html_e( 'Enable this option to hide White Label settings. Re-activate the plugin to enable this form again.', 'uabb' ); ?></p>
				<label>
					<input type="checkbox" class="uabb-hide-branding" name="uabb-hide-branding" value="" <?php echo esc_attr( $uabb_hide_branding ); ?> ><?php esc_html_e( 'Hide White Label Settings', 'uabb' ); ?>
				</label>
			</div>
