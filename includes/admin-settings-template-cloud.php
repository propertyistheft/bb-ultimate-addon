...
<div id="fl-uabb-cloud-templates-form" class="fl-settings-form uabb-cloud-templates-fl-settings-form">
	...
	<div class="fl-settings-form-header">
		<h3><?php esc_html_e( 'Template Cloud', 'uabb' ); ?></h3>
		<a target="_blank" rel="noopener" href="https://www.ultimatebeaver.com/docs/use-template-cloud/?utm_source=uabb-pro-dashboard&utm_medium=template-cloud-screen&utm_campaign=template-cloud" data-count="118" style="float: right;"><?php esc_html_e( 'How to use Page Templates?', 'uabb' ); ?></a>
	</div>
			...
			<div id="uabb-cloud-templates-tabs">
				...
				<div id="uabb-cloud-templates-inner" class="wp-filter">
					...
					<ul class="uabb-filter-links">
						<li><a href="#uabb-cloud-templates-page-templates" data-count="<?php echo wp_kses_post( UABB_Cloud_Templates::get_cloud_templates_count( 'page-templates' ) ); ?>"> <?php esc_html_e( 'Page Templates', 'uabb' ); ?> </a></li>
						<li><a href="#uabb-cloud-templates-sections" data-count="<?php echo wp_kses_post( UABB_Cloud_Templates::get_cloud_templates_count( 'sections' ) ); ?>"> <?php esc_html_e( 'Sections', 'uabb' ); ?> </a></li>
					</ul>
