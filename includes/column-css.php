	...
	foreach ( $nodes['columns'] as $column ) {
		...
		if ( isset( $column->settings->bg_type ) && 'uabb_gradient' === $column->settings->bg_type ) {
			...
			<?php if ( 'linear' === $column->settings->uabb_col_gradient_type ) { ?>
				.fl-node-<?php echo esc_attr( $column->node ); ?> > .fl-col-content {
					background-color: <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_primary_color ) ); ?>;
					background-image: -webkit-linear-gradient(<?php echo esc_attr( $column->settings->uabb_col_linear_direction ) . 'deg'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_primary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_linear_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_secondary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_linear_gradient_secondary_loc ) . '%'; ?>);
			...
			<?php if ( 'radial' === $column->settings->uabb_col_gradient_type ) { ?>
				.fl-node-<?php echo esc_attr( $column->node ); ?> > .fl-col-content {
					background-color: <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_primary_color ) ); ?>;
					background-image: -webkit-radial-gradient(<?php echo 'at ' . esc_attr( $column->settings->uabb_col_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_primary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_secondary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_secondary_loc ) . '%'; ?>);
					background-image: -moz-radial-gradient(<?php echo 'at ' . esc_attr( $column->settings->uabb_col_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_primary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_secondary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_secondary_loc ) . '%'; ?>);
					background-image: -o-radial-gradient(<?php echo 'at ' . esc_attr( $column->settings->uabb_col_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_primary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_secondary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_secondary_loc ) . '%'; ?>);
					background-image: -ms-radial-gradient(<?php echo 'at ' . esc_attr( $column->settings->uabb_col_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_primary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_secondary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_secondary_loc ) . '%'; ?>);
					background-image: radial-gradient(<?php echo 'at ' . esc_attr( $column->settings->uabb_col_radial_direction ); ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_primary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_primary_loc ) . '%'; ?>, <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->uabb_col_gradient_secondary_color ) ); ?> <?php echo esc_attr( $column->settings->uabb_col_radial_gradient_secondary_loc ) . '%'; ?>);
				}
			<?php } ?>
		<?php } ?>
		<?php
				...
				<?php if ( isset( $column->settings->border['shadow']['color'] ) && empty( $column->settings->border['shadow']['color'] ) ) { ?>
					...
					<?php if ( 'yes' === $column->settings->col_drop_shadow ) { ?>
						.fl-node-<?php echo esc_attr( $column->node ); ?> > .fl-col-content.fl-node-content {
							-webkit-box-shadow: <?php echo esc_attr( $column->settings->col_shadow_color_hor ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_ver ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_blur ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_spr ); ?>px <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->col_shadow_color ) ); ?>;
							-moz-box-shadow: <?php echo esc_attr( $column->settings->col_shadow_color_hor ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_ver ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_blur ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_spr ); ?>px <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->col_shadow_color ) ); ?>;
							-o-box-shadow: <?php echo esc_attr( $column->settings->col_shadow_color_hor ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_ver ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_blur ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_spr ); ?>px <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->col_shadow_color ) ); ?>;
							box-shadow: <?php echo esc_attr( $column->settings->col_shadow_color_hor ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_ver ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_blur ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_spr ); ?>px <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->col_shadow_color ) ); ?>;
					...
					<?php if ( 'yes' === $column->settings->col_hover_shadow ) { ?>
						.fl-node-<?php echo esc_attr( $column->node ); ?> > .fl-col-content.fl-node-content:hover {
							-webkit-box-shadow: <?php echo esc_attr( $column->settings->col_shadow_color_hor_hover ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_ver_hover ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_blur_hover ); ?>px <?php echo esc_attr( $column->settings->col_shadow_color_spr_hover ); ?>px <?php echo esc_attr( FLBuilderColor::hex_or_rgb( $column->settings->col_shadow_color_hover ) ); ?>;
