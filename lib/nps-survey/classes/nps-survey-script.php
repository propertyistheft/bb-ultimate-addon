 ...
 */
	class Nps_Survey {
		 ...
		 * @return void
		 */
		public static function show_nps_notice( string $id, array $vars = array() ) {
			...
			$show_on_screen = ! empty( $vars['show_on_screens'] ) && is_array( $vars['show_on_screens'] ) ? $vars['show_on_screens'] : array( 'dashboard' );
